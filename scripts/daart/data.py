...
def load_feature_csv(filepath: str) -> tuple:
    ...
    #unwanted_col = ['Unnamed: 0', 'oper_angle_R', 'oper_angle_L', 'oper_dist_R', 'oper_dist_L', 'oper_angle_avg', 'oper_dist_avg']
    unwanted_col = ['Unnamed: 0']
    
    for get_out in unwanted_col:
        if get_out in list(df.columns):
            df = df.drop([get_out], axis=1)
