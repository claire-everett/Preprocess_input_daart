...
meta_dir = '/Users/claireeverett/Desktop/Process_input/new_contour_script/'
...
DLC_dir = '/Users/claireeverett/Desktop/Process_input/h5_for_basefeatures/'
...
for i in np.arange(len(DLC_paths)):
    ...
    print(DLC_paths[i], new_base_features[i] )
    # load the .h5 files 
    ...
    operangle_R = auto_scoring_get_angle(filtered_df, ['A_head', 'B_rightoperculum', 'F_spine1'])[START_FRAME:END_FRAME]
    operangle_L = auto_scoring_get_angle(filtered_df, ['A_head', 'E_leftoperculum', 'F_spine1'])[START_FRAME:END_FRAME]
    
    operdist_R = oper_diff(filtered_df, ['B_rightoperculum', 'F_spine1'])[START_FRAME:END_FRAME]
    operdist_L = oper_diff(filtered_df, ['E_leftoperculum', 'F_spine1'])[START_FRAME:END_FRAME]
